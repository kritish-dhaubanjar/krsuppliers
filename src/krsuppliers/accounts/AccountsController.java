            ...
            Task<String> task = new Task<String>() {
                ...
                protected String call() throws Exception {
                    try {
                        ...
                        statement.execute("CREATE TABLE balance (_id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT, date DATE NOT NULL, bill INTEGER NOT NULL DEFAULT 0, particular_id INTEGER NOT NULL, particular TEXT NOT NULL, qty FLOAT NOT NULL, rate FLOAT NOT NULL, discount FLOAT NOT NULL, amount FLOAT NOT NULL)");
                        statement.execute("CREATE TABLE purchases(_id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT, date DATE NOT NULL, bill INTEGER NOT NULL DEFAULT 0, particular_id INTEGER NOT NULL, particular TEXT NOT NULL, qty FLOAT NOT NULL, rate FLOAT NOT NULL, discount FLOAT NOT NULL, amount FLOAT NOT NULL, cancel TINYINT NOT NULL DEFAULT 0)");
                        statement.execute("CREATE TABLE sales(_id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT, date DATE NOT NULL, bill INTEGER NOT NULL DEFAULT 0, particular_id INTEGER NOT NULL, particular TEXT NOT NULL, qty FLOAT NOT NULL, rate FLOAT NOT NULL, discount FLOAT NOT NULL, amount FLOAT NOT NULL, cancel TINYINT NOT NULL DEFAULT 0)");
